...
window.onload=function(){
  ...
  function addUser(){
    ...
    console.log(us)
    $.ajax({
      "method":"POST",contentType:"application/json",'data':us,'url':'https://teamrocketapi.prashantdey.in/a',
  ...
  function validate(){
    ...
    $.ajax({
      "method":"POST",contentType:"application/json",'data':login,'url':'https://teamrocketapi.prashantdey.in/a/login',
      "success":function(e){
        if(e){
          // console.log(e.role)
