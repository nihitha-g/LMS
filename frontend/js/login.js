...
window.onload=function(){
  ...
  function addUser(){
    ...
    console.log(us)
    $.ajax({
      "method":"POST",contentType:"application/json",'data':us,'url':'http://44.192.4.165:9999/a',
  ...
  function validate(){
    ...
    $.ajax({
      "method":"POST",contentType:"application/json",'data':login,'url':'http://44.192.4.165:9999/a/login',
      "success":function(e){
        if(e){
          // console.log(e.role)
