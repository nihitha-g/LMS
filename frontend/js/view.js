...
function get_req() {
  ...
  $.post("https://teamrocketapi.prashantdey.in/" + ind, function (data, status) {
...
function enroll(){
  ...
  enrollButton.innerHTML = "You are now enrolled";
        ...
        $.ajax({
          ...
          "data": obj,
          url: 'https://teamrocketapi.prashantdey.in/enroll/e',
           success: (e) => {
...
function fun2() {
  ...
  console.log(bhi)
  $.ajax({
    "method": "POST", contentType: "application/json", "data": bhi, "url": "https://teamrocketapi.prashantdey.in/LogOutUser/logout",
    "success": (e) => {
